#make_HTML_file(start,end,'12:00',self.resto_table,just_best=True)
...
class make_HTML_file(object):
	def __init__(self, resto_table, just_best, time_leaving=None):
		...
		self.main(resto_destination_time)

	def write_resturants(self, resto_keys, resto_destination_time, html_file):
	...
	def main(self, resto_destination_time):
		...
		write_resturants(self.sorted_resto_keys[:4], resto_destination_time, html_file)
		html_file.write('\n</div>\n')
		write_resturants(self.sorted_resto_keys[4:], resto_destination_time, html_file)
